...
import w1 from '../../images/appdev.svg';
import logo from '../../images/adg_logo.jpg';
...
const Workshop1 = () => {
  ...
  return (
    ...
    <div className="text-center">
          <h2 className="lg:text-4xl text-3xl text-[#05E0EE] font-bold font-heading mb-6">App Development</h2>
        ...
        <div className="mt-8">
          ...
          <div className="mt-6 flex justify-center items-center gap-8 text-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="font-semibold text-base text-[#EAEAEA] font-body">28th January, 2025</p>
            </div>
