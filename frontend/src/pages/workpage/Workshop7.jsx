...
const Workshop1 = () => {
  return (
    ...
    <div className="text-center">
          <h2 className="text-4xl text-[#05E0EE] font-bold font-heading mb-6">App Development</h2>
