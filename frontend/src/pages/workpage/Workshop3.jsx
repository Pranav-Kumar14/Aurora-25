...
import w1 from '../../images/ui_ux.svg';
import logo from '../../images/leanin.jpeg';
...
const Workshop1 = () => {
  ...
  return (
    ...
    <div className="text-center">
          <h2 className="lg:text-4xl text-3xl text-[#05E0EE] font-bold font-heading mb-6">Intro to UI/UX</h2>
