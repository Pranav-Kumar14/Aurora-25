...
const Workshop1 = () => {
  return (
    ...
    <div className="text-center">
          <h2 className="text-4xl text-[#05E0EE] font-bold font-heading mb-6">VisionCraft: Mastering Computer Vision</h2>
      ...
      <section className="mt-12 w-full max-w-4xl bg-[rgba(255,255,255,0.06)] rounded-[36px] border border-[#EAEAEA] shadow-md shadow-[rgba(0,0,0,0.25)] backdrop-blur-[17.5px] p-8 pt-[95px]">
        ...
        <div className="mt-8">
          ...
          <div className="mt-6 flex justify-center items-center gap-8 text-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="font-semibold text-base text-[#EAEAEA] font-body">26th January, 2025</p>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="font-semibold text-[#EAEAEA] text-base font-body">AB 3, 305</p>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="font-semibold text-[#EAEAEA] text-base font-body">3:30 pm onwards</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 pt-9 p-6 rounded-[36px] bg-[rgba(255,255,255,0.1)] border border-[#EAEAEA] shadow-md shadow-[rgba(0,0,0,0.25)] backdrop-blur-[17.5px] pt-[56px]">
          ...
          ACM-W is a dynamic community dedicated to empowering women in computing. We explore diverse fields like artificial intelligence, machine learning, software development, and data science through hands-on workshops, mentorship, and collaborative projects. Our goal is to create an inclusive space where students can learn, innovate, and connect with like-minded peers.
          </p>
        </div>
        ...
        <div className="text-center mt-8">
          <button
            className="rounded-[135px] bg-orange-400 shadow-inner shadow-[0_4px_6px_5px_rgba(0,0,0,0.25)] px-6 py-2 text-white font-semibold hover:bg-[#04c3d0] transition duration-300 ease-in-out"
          >
            Go To Workshop Page
          </button>
