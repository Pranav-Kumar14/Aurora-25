...
import w1 from '../../images/compvision.svg';
import logo from '../../images/ACMW_LOGO.png';
  ...
  return (
    ...
    <div className="text-center">
      ...
      <section className="mt-12 w-full max-w-4xl bg-[rgba(255,255,255,0.06)] rounded-[36px] border border-[#EAEAEA] shadow-md shadow-[rgba(0,0,0,0.25)] backdrop-blur-[17.5px] p-8 pt-[95px]">
        ...
        <div className="mt-8">
          ...
          <div className="mt-6 flex justify-center items-center gap-8 text-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="font-semibold text-base text-[#EAEAEA] font-body">31st January, 2025</p>
            </div>
        ...
        <div className="mt-8 pt-9 p-6 rounded-[36px] bg-[rgba(255,255,255,0.1)] border border-[#EAEAEA] shadow-md shadow-[rgba(0,0,0,0.25)] backdrop-blur-[17.5px] pt-[56px] relative">
