...
import w1 from '../../images/cryptography.svg';
...
const Workshop1 = () => {
  ...
  return (
    ...
    <div className="text-center">
          <h2 className="lg:text-4xl text-3xl text-[#05E0EE] font-bold font-heading mb-6">HackLinux: Cryptography and Web Exploitation</h2>
        ...
        <div className="mt-8">
          ...
          <div className="mt-6 flex justify-center items-center gap-8 text-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="font-semibold text-base text-[#EAEAEA] font-body">27th January, 2025</p>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="font-semibold text-[#EAEAEA] text-base font-body">2:30 pm onwards</p>
            </div>
          </div>
        </div>
