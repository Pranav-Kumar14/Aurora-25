...
import w1 from '../../images/astronomy.svg';
import logo from '../../images/tacm.jpeg';
        ...
        <div className="mt-8">
          ...
          <div className="mt-6 flex justify-center items-center gap-8 text-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="font-semibold text-[#EAEAEA] text-base font-body">Athletic Ground</p>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="font-semibold text-[#EAEAEA] text-base font-body">9:00 pm onwards</p>
            </div>
          </div>
        </div>
