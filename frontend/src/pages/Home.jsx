...
import MitPost from "../components/mitPost.jsx";
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (video) {
        ...
        }px) scale(${1 + scrollTop * scaleSpeed})`;
      }
    };
    ...
    <>
      {isLaptop && (
        <div className="bg-gradient-to-r from-[#0f0d39] to-[#201867]">
          ...
          <div className="lg:py-6 lg:mb-3 relative z-10"> 
  <p className="font-heading text-center text-white text-2xl sm:text-3xl lg:text-5xl lg:pb-4 my-1">
    MEDIA PARTNER
  </p>
  <MitPost />
</div>
          ...
          >
            ...
            <div className="flex justify-center space-x-6">
              <a
                href="https://www.instagram.com/iste_manipal/"
                className="text-white hover:text-gray-400"
              >
                <i className="fab fa-instagram text-2xl"></i>
              </a>
              <a
                href="https://www.facebook.com/istemanipal/"
                className="text-white hover:text-gray-400"
              >
                <i className="fab fa-facebook text-2xl"></i>
              </a>
              <a
                href="https://in.linkedin.com/company/iste-manipal"
                className="text-white hover:text-gray-400"
              >
            ...
            <p className="text-sm mb-2">
              ...
              <br /> +91-9845780894 | +91-8809795723
            </p>
            <p className="text-sm">
      ...
      {isPhone && (
        <div
          className="bg-gradient-to-r from-[#0f0d39] to-[#201867] bg-cover bg-top bg-fixed z-50 relative top-[-2rem]"
        ...
        >
          ...
          <div className="lg:py-3 lg:mb-1 relative z-10">
            <p className="font-heading text-center text-white text-2xl sm:text-3xl lg:text-5xl lg:pb-3 my-1">
              MEDIA PARTNER
            </p>
            <MitPost />
          </div>
