...
const CtfHero = () => {
  return (
    <div className="relative text-center py-16 h-screen">
      ...
      <div className="relative z-10 flex flex-col pt-11 items-center w-full h-full px-6">
        <h1 className="text-6xl font-bold text-white pb-10 capitalize font-['Chakra Petch']">
          CAPTURE THE FLAG
        </h1>

        <div className="bg-[#040222] bg-opacity-80 shadow-[0px_0px_18px_7px_rgba(255,255,255,1.00)] p-8 rounded-lg max-w-4xl mx-auto">
          <p className="text-white text-lg font-medium font-['Chakra Petch']">
